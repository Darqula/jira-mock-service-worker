...
export function createProjectPropertiesHandlers(dataStore: DataStore, baseUrl: string) {
  return [
    ...
    http.get(`${baseUrl}/rest/api/2/project/:projectIdOrKey/properties/:propertyKey`, ({ params }) => {
    ...
    http.put(`${baseUrl}/rest/api/2/project/:projectIdOrKey/properties/:propertyKey`, async ({ params, request }) => {
      const { projectIdOrKey, propertyKey } = params;
    ...
    http.delete(`${baseUrl}/rest/api/2/project/:projectIdOrKey/properties/:propertyKey`, ({ params }) => {
      const { projectIdOrKey, propertyKey } = params;
