 ...
 */
export const ChildDistributionSchema = z
  .object({
 ...
 */
export const IssueTypesConfigSchema = z
  .object({
 ...
 */
export const SprintsConfigSchema = z
  .object({
 ...
 */
export const WorklogsConfigSchema = z
  .object({
 ...
 */
export const ProjectConfigWithKeySchema = z
  .object({
    projectKey: z
      .string()
